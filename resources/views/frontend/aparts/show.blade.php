...
@section('metaTitle', 'Найти квартиру, дом в Буэнос-Айресе. '. $apartment->title)
    ...
    <div class="container">
        <div class="row">
            <div class="page-head-content">
                <h1 class="page-title">{{ $apartment->title }}, {{ (int) $apartment->price }} USD</h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-8 single-property-content ">
                    ...
                    <div class="light-slide-item">
                        <div class="clearfix">
                            ...
                            <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                @if ($apartment->photo)
                                    <li data-thumb="{{ asset('storage/aparts/'. $apartment->chat_id .'/'. $apartment->msg_id .'/'. $apartment->photo) }}">
                ...
                <div class="single-property-wrapper">
                    <div class="single-property-header">
                        <h1 class="property-title pull-left">{{ $apartment->title }}</h1>
                        <span class="property-price pull-right">{{ (int) $apartment->price }} USD</span>
                    </div>
...
{{--                    <!-- .property-meta -->--}}
                    ...
                    <div class="section">
                        <h4 class="s-property-title">Описание</h4>
                        <div class="s-property-content">
                            <p>{!! nl2br($rawApartments->msg) !!}</p>
                        </div>
                    </div>
                    <!-- End description area  -->

                    <div class="section property-video">
                        <h4 class="s-property-title">На карте</h4>
                        @if ($apartment->lng)
                            <div class="video-thumb">
                                @include('frontend.aparts._partial.map')
                            </div>
                        @else
                            <p>Пока что метка на карте отсутствует</p>
                        @endif
                    </div>
                    <!-- End video area  -->
                </div>
            ...
            <div class="col-md-4 p0">
                <aside class="sidebar sidebar-property blog-asside-right">
                    @include('frontend.aparts._partial.realtor_info')
