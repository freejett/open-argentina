...
return [
    ...
    */
    ...
    'crm_owner' => env('LARAVEL_CRM_OWNER', 'support@open-agrentina.com'),
    ...
    */
    ...
    'teams' => env('LARAVEL_CRM_TEAMS', true),
    ...
    */
    ...
    'currency' => env('LARAVEL_CRM_CURRENCY', 'ARS'),

    'country' => env('LARAVEL_CRM_COUNTRY', 'Argentina'),

    'language' => env('LARAVEL_CRM_LANGUAGE', 'russian'),
