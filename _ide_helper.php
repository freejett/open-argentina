...
')
     ...
     */ 
         ...
         * 
         *
         * @see \VentureDrake\LaravelCrm\LaravelCrmServiceProvider::boot()
         * @param mixed $perPage
         * @param mixed $page
         * @param mixed $options
         * @static 
         */ 
        public static function paginate($perPage = 30, $page = null, $options = [])
        {
     ...
     */ 
        ...
        {
                        /** @var \Dcblogdev\Xero\Xero $instance */
                        return $instance->setTenantId($tenant_id);
        }
                    /**
         * 
         *
         ...
         *
         * @return \Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application|\Illuminate\Routing\Redirector 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function getAccessToken($redirectWhenNotConnected = true)
        {
                        /** @var \Dcblogdev\Xero\Xero $instance */
                        return $instance->getAccessToken($redirectWhenNotConnected);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function renewExpiringToken($token)
        {
                        /** @var \Dcblogdev\Xero\Xero $instance */
                        return $instance->renewExpiringToken($token);
        }
                    /**
         * 
         *
     ...
     */ 
        ...
        {
                        /** @var \VentureDrake\LaravelCrm\LaravelCrm $instance */
                        return $instance->searchLeads();
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class Xero extends \Dcblogdev\Xero\Facades\Xero {}
            ...
            class LaravelCrm extends \VentureDrake\LaravelCrm\Facades\LaravelCrmFacade {}
